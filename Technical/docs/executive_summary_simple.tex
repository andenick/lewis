...
\begin{itemize}
    \item \textbf{United States}: BEA International Transactions, FRED Economic Series, Treasury International Capital
    \item \textbf{United Kingdom}: ONS Balance of Payments (longest continuous series: 1946-2023)
    \item \textbf{Germany}: Bundesbank Balance of Payments (detailed monthly data: 1971-2024)
    \item \textbf{International}: World Bank GDP, IMF Balance of Payments, OECD Trade Statistics
\end{itemize}
