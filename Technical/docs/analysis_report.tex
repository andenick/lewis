...
\begin{tikzpicture}[scale=0.8, transform shape]
    ...
    \addplot[blue, thick] coordinates {(1960,0.5) (1970,0.8) (1980,0.3) (1990,-1.2) (2000,-4.8) (2010,-2.6) (2020,-2.1)};
    \addlegendentry{United States}

    \addplot[red, thick] coordinates {(1960,1.2) (1970,1.5) (1980,-0.8) (1990,-1.0) (2000,-2.5) (2010,1.8) (2020,2.1)};
    \addlegendentry{United Kingdom}

    \addplot[green, thick] coordinates {(1971,1.8) (1980,2.1) (1990,1.2) (2000,5.2) (2010,7.1) (2020,6.8)};
    \addlegendentry{Germany}

    \end{axis}
\end{tikzpicture}
\caption{Current Account Balances: United States, United Kingdom, Germany (1960-2024)}
\end{figure}

\subsubsection{Divergence Patterns}
...
\begin{itemize}
    ...
    \textbf{Employment Effects}: Sectoral job reallocation
\end{itemize}
...
\begin{itemize}
    ...
    \textbf{U.K. Costs}: Financial sector adjustment
    \textbf{Convergence Process}: Economic cycle synchronization
    \textbf{Monetary Policy}: ECB unified framework
\end{itemize}
...
\begin{itemize}
    ...
    \textbf{German Manufacturing}: Export-oriented FDI in Europe
...
\begin{itemize}
    ...
    \textbf{External Buffer}: Protection against external shocks
    \item{Policy Flexibility}: Greater monetary and fiscal policy space
    \textbf{International Influence}: Enhanced global economic role
\end{itemize}
...
\begin{enumerate}
    ...
    \textbf{Historical Impact}: Major events have fundamentally altered international economic relationships
    \textbf{Policy Implications}: Different vulnerabilities and policy requirements for each country
\end{enumerate}
...
\begin{itemize}
    ...
    \textbf{Bilateral Analysis}: Detailed country-to-country relationship studies
    \textbf{Sectoral Studies}: Industry-specific international trade analysis
    \textbf{Policy Simulation}: Impact assessment of proposed economic policies
\end{itemize}
